...
(function () {
    ...
    function widgetService($http, $routeParams) {
        ...
        function sortWidget(initial, final) {
            var url = "/assignment6/page/"+ $routeParams.pageId + "/widget?initial=" + initial + "&final=" + final;
            $http.put(url);
        }

        function createWidget(pageId, widget) {
            var url="/api/assignment6/page/"+pageId+"/widget";
            var data = {
                pageId: pageId,
                widget: widget
            };
        ...
        function findWidgetById(widgetId) {
            ...
            var url="/api/assignment6/widget/"+widgetId;
            return $http.get(url)
